...
internal class SevenSegmentsTest {
    ...
    private val problemInput = File("src/test/resources/aoc2021/day8/input.txt").readText()

    @Test
    fun `part 1 test`() {
        verifyPart1(SevenSegments.parse(exampleInput), 26)
    }

    @Test
    fun `part 1 real`() {
        verifyPart1(SevenSegments.parse(problemInput), 375)
    }
